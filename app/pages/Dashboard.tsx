...
import { DynamicCustomDashboardPanel, useDashboardCustomization } from "../hooks/useDashboardCustomization";
...
export default function Dashboard() {
  ...
  const { customizationEnabled, useCustomDashboardPanel } = customizationConfig;
